...
function get_sets()
	...
	-- Lock Style
	windower.send_command('@wait 5;input /lockstyleset 3')
end
...
function init_gear_sets()
    ...
    sets.precast.FC = {
		head="Haruspex Hat", feet="Chelona boots",
		ring1="Prolix Ring", back="Swith Cape +1",waist="Witful Belt"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {})

    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {neck="Stoicheion Medal"})

    sets.precast.FC.Cure = set_combine(sets.precast.FC, {body="Nefer Kalasiris", waist="Acerbic Sash +1"})
    ...
    sets.midcast['Enfeebling Magic'] = {
		main="Arasy Staff +1", sub="Elder's Grip +1", ammo="Memoria Sachet",
		head="Spae. Petasos +2", neck="Src. Stole +1", right_ear="Friomisi Earring",
		body="Spaekona's Coat +2", hands="Spae. Gloves +2", left_ring="Icesoul Ring", right_ring="Icesoul Ring",
		back="Seshaw Cape +1", waist="Ovate Rope", legs="Spae. Tonban +2", feet="Spae. Sabots +2",
	}
    ...
    sets.midcast['Dark Magic'] = {
		...
		head="Spae. Petasos +2", neck="Src. Stole +1", right_ear="Friomisi Earring",
		body="Spaekona's Coat +2", hands="Spae. Gloves +2", left_ring="Icesoul Ring", right_ring="Icesoul Ring",
		back="Seshaw Cape +1", waist="Othila Sash", legs="Spae. Tonban +2", feet="Spae. Sabots +2"
	}
    ...
    sets.idle = {
		main="Arasy Staff +1", sub="Menesch Strap", ammo="Memoria Sachet",
		head="Spae. Petasos +2", neck="Wiglen Gorget", right_ear="Friomisi Earring",
		body="Spaekona's Coat +2", hands="Spae. Gloves +2", ring1="Moonlight Ring", ring2="Defending Ring",
		back="Moonbeam Cape", waist="Othila Sash", legs="Spae. Tonban +2", feet="Herald's Gaiters",
	}

    -- Idle mode that keeps PDT gear on, but doesn't prevent normal gear swaps for precast/etc.
    sets.idle.PDT = {
		main="Terra's Staff", sub="Menesch Strap", ammo="Memoria Sachet",
		head="Spae. Petasos +2", neck="Wiglen Gorget", right_ear="Friomisi Earring",
		body="Spaekona's Coat +2", hands="Spae. Gloves +2", ring1="Moonlight Ring", ring2="Defending Ring",
		back="Moonbeam Cape", waist="Othila Sash", legs="Spae. Tonban +2", feet="Spae. Sabots +2",
	}
