...
function init_gear_sets()
    ...
    sets.precast.FC = {
        ...
        ring1="Prolix Ring",
        back="Swith Cape +1",waist="Witful Belt",legs="Geomancy Pants +2",feet="Chelona Boots"}

    sets.precast.FC.Cure = set_combine(sets.precast.FC, {body="Nefer Kalasiris"})
	...
	sets.midcast['Elemental Magic'] = {
		head="Ea Hat", neck="Bagua Charm +1", right_ear="Friomisi Earring",
		body="Ea Houppelande", hands="Ea Cuffs", left_ring="Icesoul Ring", right_ring="Icesoul Ring",
		back="Seshaw Cape +1", waist="Othila Sash", legs="Ea Slops", feet="Ea Pigaches",
    }
    ...
    sets.idle = {
		head="Geo. Galero +2", neck="Wiglen Gorget", right_ear="Friomisi Earring",
		body="Geomancy Tunic +2", hands="Geo. Mitaines +2", left_ring="Icesoul Ring", right_ring="Icesoul Ring",
		back="Moonbeam cape", legs="Geomancy Pants +2", feet="Geo. Sandals +2",
	}
